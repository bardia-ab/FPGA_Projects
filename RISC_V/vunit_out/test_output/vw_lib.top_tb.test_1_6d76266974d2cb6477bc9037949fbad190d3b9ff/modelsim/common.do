...
proc is_test_suite_done {} {
    set fd [open "C:/Users/t26607bb/Desktop/Interface_Course/FPGA_Projects/RISC_V/vunit_out/test_output/vw_lib.top_tb.test_1_6d76266974d2cb6477bc9037949fbad190d3b9ff/vunit_results" "r"]
...
proc vunit_compile {} {
    set cmd_show {C:\Users\t26607bb\AppData\Local\Programs\Python\Python310\python.exe -u .\run.py --compile -g}
    puts "Re-compiling using command ${cmd_show}"

    set chan [open |[list {C:\Users\t26607bb\AppData\Local\Programs\Python\Python310\python.exe} {-u} {-c} {import sys;import subprocess;exit(subprocess.call(['C:\\Users\\t26607bb\\AppData\\Local\\Programs\\Python\\Python310\\python.exe', '-u', '.\\run.py', '--compile', '-g'], cwd='C:\\Users\\t26607bb\\Desktop\\Interface_Course\\FPGA_Projects\\RISC_V', bufsize=0, universal_newlines=True, stdout=sys.stdout, stderr=sys.stdout))}] r]
