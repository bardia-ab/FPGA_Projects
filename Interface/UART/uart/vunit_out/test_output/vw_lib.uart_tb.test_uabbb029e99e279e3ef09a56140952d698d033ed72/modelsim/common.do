...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-modelsimini C:/Users/t26607bb/Desktop/Interface_Course/FPGA_Projects/Interface/UART/uart/vunit_out/modelsim/modelsim.ini -wlf {C:/Users/t26607bb/Desktop/Interface_Course/FPGA_Projects/Interface/UART/uart/vunit_out/test_output/vw_lib.uart_tb.test_uabbb029e99e279e3ef09a56140952d698d033ed72/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/uart_tb/runner_cfg={"active python runner : true,enabled_test_cases : test_uart_tx,output path : C::/Users/t26607bb/Desktop/Interface_Course/FPGA_Projects/Interface/UART/uart/vunit_out/test_output/vw_lib.uart_tb.test_uabbb029e99e279e3ef09a56140952d698d033ed72/,tb path : C::/Users/t26607bb/Desktop/Interface_Course/FPGA_Projects/Interface/UART/uart/,use_color : true"} vw_lib.uart_tb(sim)   -L vunit_lib -L vw_lib}
    }]

    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -modelsimini C:/Users/t26607bb/Desktop/Interface_Course/FPGA_Projects/Interface/UART/uart/vunit_out/modelsim/modelsim.ini -wlf {C:/Users/t26607bb/Desktop/Interface_Course/FPGA_Projects/Interface/UART/uart/vunit_out/test_output/vw_lib.uart_tb.test_uabbb029e99e279e3ef09a56140952d698d033ed72/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/uart_tb/runner_cfg={"active python runner : true,enabled_test_cases : test_uart_tx,output path : C::/Users/t26607bb/Desktop/Interface_Course/FPGA_Projects/Interface/UART/uart/vunit_out/test_output/vw_lib.uart_tb.test_uabbb029e99e279e3ef09a56140952d698d033ed72/,tb path : C::/Users/t26607bb/Desktop/Interface_Course/FPGA_Projects/Interface/UART/uart/,use_color : true"} vw_lib.uart_tb(sim)   -L vunit_lib -L vw_lib' failed
...
proc is_test_suite_done {} {
    set fd [open "C:/Users/t26607bb/Desktop/Interface_Course/FPGA_Projects/Interface/UART/uart/vunit_out/test_output/vw_lib.uart_tb.test_uabbb029e99e279e3ef09a56140952d698d033ed72/vunit_results" "r"]
...
proc vunit_compile {} {
    set cmd_show {C:\Users\t26607bb\AppData\Local\Programs\Python\Python310\python.exe -u .\run.py --compile}
    puts "Re-compiling using command ${cmd_show}"

    set chan [open |[list {C:\Users\t26607bb\AppData\Local\Programs\Python\Python310\python.exe} {-u} {-c} {import sys;import subprocess;exit(subprocess.call(['C:\\Users\\t26607bb\\AppData\\Local\\Programs\\Python\\Python310\\python.exe', '-u', '.\\run.py', '--compile'], cwd='C:\\Users\\t26607bb\\Desktop\\Interface_Course\\FPGA_Projects\\Interface\\UART\\uart', bufsize=0, universal_newlines=True, stdout=sys.stdout, stderr=sys.stdout))}] r]
